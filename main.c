...
int main()
{
    ...
    if (Reponse==3){
        ...
        do{
            ...
            int CouleurAtout=9, PhaseDeJeu=60, i,j;
            ...
            for (i=0;i<8;i++){
                ...
                }else if (VainqueurManche==72){
                    Pli[0]=JeuBot(MainOuest, CouleurAtout, Pli);
                    for(j=0;j<8;j++){
                        if(MainOuest[j]==Pli[0]){
                            MainOuest[j]=0;
                        }
                    }
                ...
                Vainqueur=GagnantPli(Pli, CouleurAtout,VainqueurManche);
